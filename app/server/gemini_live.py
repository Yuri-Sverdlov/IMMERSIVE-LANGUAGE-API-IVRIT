...
class GeminiLive:
    def __init__(self, project_id: str, location: str, model: str, input_sample_rate: int = 16000, api_key: Optional[str] = None):
        self.project_id = project_id
        self.location = location
        self.model = model
        self.input_sample_rate = input_sample_rate
        print("GeminiLive init: model=%s, sample_rate=%d, mode=%s" % (
            model, input_sample_rate, "api_key" if api_key else "vertex"
        ))
